...
class App extends React.Component {
  ...
  handleScroll = () => {
    ...
    if (prevScrollpos > 300) {
      this.setState({
        portfolio: "",
        about: "animated slideInUp slow",
        contact: ""
      });
    } else if (prevScrollpos > 1000) {
      this.setState({
        about: "",
        contact: "animated slideInUp slow",
        portfolio: ""
      });
    }
  };
            ...
            <div id="portfolio" className=" card-deck portfolio1">
              <div className="col-sm-6 animated pulse infinite slower ">
                <Portfolio
                  ...
                  prag="A website that describes IT JOBS well designed and well optimized,Mobile responsive"
                  img={cyj}
              ...
              <div className="col-sm-6  animated pulse infinite slower">
                <Portfolio
                  ...
                  prag="A portfolio-website Portfolio section,about section , contact section , footer,welcome page and some nice animations ,Mobile responsive"
                  img={port}
                  timeUpdated="19/06/2019"
              ...
              <div className="col-sm-6 animated pulse infinite slower">
                <Portfolio
                  title="Note Tasks WEB application"
                  prag="Note/Tasks WEB application made with ReactJS/Firebase/Bootstrap/UI/UX/Mobile responsive"
                  img={note}
                  timeUpdated="12/07/2019"
              ...
              <div className="col-sm-6 animated pulse infinite slower">
                <Portfolio
                  ...
                  prag="Weather Application Using API /ReactJS/Bootstrap/JS/Animations/Mobile responsive"
                  img={weather}
                  timeUpdated="14/07/2019"
                  link="https://bahachammakhi.github.io/WeatherAPP/"
                />
              </div>
            </div>{" "}
          </div>
